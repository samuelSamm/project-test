...
$(function () {
    ...
    resendSingleAward = function (idAward) {

        $.ajax({
            type: 'GET',
            url: urlAwards + "resend-single-award?idAward=" + idAward,
    ...
    previewSave = function (descriptionTypeAward, fullName, template, description, message) {
         var params =
